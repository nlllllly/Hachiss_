...
ActiveRecord::Schema.define(version: 2020_09_05_073237) do
  ...
  create_table "genres", force: :cascade do |t|
    ...
    t.integer "genre_status", default: 1, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "producer_favorites", force: :cascade do |t|
  ...
  create_table "producers", force: :cascade do |t|
    ...
    t.integer "producer_status", default: 1, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
